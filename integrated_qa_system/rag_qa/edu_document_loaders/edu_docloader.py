...
if __name__ == '__main__':
    docx_loader = OCRDOCLoader(filepath='/Users/erainm/Documents/application/dev/workSpace/rag_system/integrated_qa_system/rag_qa/data/ocr_samples/ocr_02.docx')
